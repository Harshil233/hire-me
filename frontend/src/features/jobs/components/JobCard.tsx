...
export interface JobCardProps {
  ...
  /** Marks a listing this candidate has already applied to. */
  ...
  return (
    <article className="surface-card surface-card-interactive overflow-hidden">
      <div className="flex gap-4 p-5">
        <CompanyLogo name={job.company.name} logoFileId={job.company.logoFileId} />
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            {/* A column, not two inline boxes: a margin cannot separate inline-level
                siblings, so the badge used to sit flush against the pay figure. */}
